...
if($count==0){
    ...
    echo "
    <h3 style = 'margin-left: 37%; color:brown;font-size: 30px'> Remove Customer Account</h3>
    ...
    <td  style= 'color:green;font-size: 20px;font-weight:bold; height: 50px; text-align:center'> Remove </td>
    </tr> 
   ...
   <td> <form action = remove.php method = 'get'> 
    <button name = 'idd' type = 'submit' value = '$CaccountNo' class='btn btn-danger' style= 'font-weight:bold;  text-align:center ; margin-left: 10%' > Remove </button>
    </form></td>
    </tr>
    ";
